        ...
        for(int i=0; i<switchesId.length; i++){
                if(w>=0){
                    ...
                    if(switchesId.length==1){
                          networkCFSswitches.get(switchesId[i]).addFlow(flowId,packetID,w,true);
                          networkCfsFRswitches.get(switchesId[i]).addFlow(flowId,packetID,w,true);
                    }
                    else{
                        networkCFSswitches.get(switchesId[i]).addFlow(flowId,packetID,w,false);
                        networkCfsFRswitches.get(switchesId[i]).addFlow(flowId,packetID,w,false);
                    }
                }
        }
